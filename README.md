...
```bash
git clone https://github.com/Adela015/Calculadora-SHEIN-ML.git
cd Calculadora-SHEIN-ML
```
...
| **Impuestos Tarjeta/Aduana (%)** | Recargo por impuesto PAIS, aduana o tarjeta | `60` |
...
│
├── assets/
│   └── imagen-proyecto.png  # Captura de pantalla de la app
...
Hecho con 💜 para vendedoras argentinas de Mercado Libre
</div>
